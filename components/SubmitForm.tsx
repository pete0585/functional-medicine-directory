...
export default function SubmitForm() {
    ...
    if (submitted) {
        return (<div className="card p-12 text-center max-w-lg mx-auto">
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="card p-8 space-y-6 max-w-2xl mx-auto">
      ...
      <div>
        ...
        <textarea className="input min-h-[100px] resize-none" placeholder="Brief description of your approach to functional medicine..." {...register('bio')}/>
      </div>
      ...
      {error && (<div className="rounded-xl bg-red-50 border border-red-200 p-3 text-sm text-red-600">
          {error}
        </div>)}
      ...
      <p className="text-xs text-slate-400 text-center"> Listings are free. Public contact details are available without payment. </p>
    </form>);
}
const US_STATES = [
